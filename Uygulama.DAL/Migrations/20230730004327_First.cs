    ...
    public partial class First : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Calori", "CreatedBy", "CreatedDate", "Picture", "ProductName", "Serving", "State", "UpdateBy", "UpdateDate" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "BirthDate", "CreatedBy", "CreatedDate", "Email", "Firstname", "Lastname", "Password", "Role", "State", "UpdateBy", "UpdateDate" },
                values: new object[,]
                {
                    { 1, new DateTime(1992, 12, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), null, new DateTime(2023, 7, 30, 3, 43, 26, 868, DateTimeKind.Local).AddTicks(8367), "admin@gmail.com", "Eren", "Kartal", "Ek1.", "Admin", "Created", null, null },
                    { 2, new DateTime(1999, 6, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), null, new DateTime(2023, 7, 30, 3, 43, 26, 868, DateTimeKind.Local).AddTicks(8474), "pelin@gmail.com", "Pelin", "Uru", "1234", "StandartUser", "Created", null, null }
                });
